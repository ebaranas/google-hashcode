...
class Car:
    ...
    def checkviability(self, ride):
        ...
        totaldrive = time2target + ridedistance
        if totaldrive > self.gametime:  # FIXME: check if > or >=
    ...
    def assignride(self, ride):
        ...
        self.cur_pos = pend
        self.curtime += distance(self.cur_pos, pstart)
        return True
    ...
    def orderrides(self, rides):
        ...
        return (bestride, self.score(bestride))

    def score(self, ride):
        return self.scoredisttime(ride)
    ...
    def scoredisttime(self, ride):
        ...
        bonus = int(self.curtime + distance(self.cur_pos, posstart) <= start)
